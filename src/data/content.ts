...
export const product = {
  ...
  headline: 'Соберите инфопродукт, который выглядит как сильный бренд, а продается как система.',
  description: 'Orbit Method помогает экспертам упаковать знания в обучение с понятным позиционированием, AI-производством контента, страницей продаж, воронкой заявок и первыми продажами без хаотичного запуска.',
  startDate: 'Поток 18 мая',
  seats: '24 места',
  conversion: '+38% средний рост конверсии заявок',
}
...
export const caseStudies: CaseStudy[] = [
  { name: 'Алина Морозова', role: 'консультант по B2B-продажам', result: '17 заявок за 9 дней', metric: '2.1 млн ₽ выручки потока', quote: 'До программы у меня были консультации и набор заметок. После Orbit появился продукт, воронка и спокойная логика продажи без ощущения инфобизнеса.', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=900&q=80' },
  { name: 'Илья Рубцов', role: 'продуктовый дизайнер', result: 'курс собран за 6 недель', metric: '43% конверсия заявки в созвон', quote: 'Самым ценным был не дизайн лендинга, а структура: кому продаем, почему сейчас, что человек получает и где доказательства.', image: '/ilya.png' },
  { name: 'Мира Сафина', role: 'методист корпоративного обучения', result: '3 тарифа без путаницы', metric: '58 учеников в первом запуске', quote: 'Мы перестали продавать часы и начали продавать путь. Тарифы стали понятными, а форма заявки сразу фильтрует неподходящих клиентов.', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=900&q=80' },
]
...
export const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=900&q=80', alt: 'Команда работает над проектом' },
  { src: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=900&q=80', alt: 'Рабочая сессия с ноутбуком' },
  { src: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&w=900&q=80', alt: 'Стратегическое планирование продукта' },
]
